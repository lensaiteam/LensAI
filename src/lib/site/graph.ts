...
export const PIPELINE = [
  ...
  { n: "04", h: "Flag", p: "A divergence engine — arithmetic, no model — flags states that are historically extreme, documented relationships that have broken, and structural signatures: spot-led, leverage-led, fragile.", artifact: "extreme_state · market_depth · P07 ≤ 0.05 · fired" },
